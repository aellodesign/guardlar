{
    ...
    client.on("guildBanAdd", async function (guild, user) {
        ...
        let channel = client.channels.cache.get(ayarlar.banlog)
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("guildMemberRemove", async kickhammer => {
        ...
        if (entry.action == `MEMBER_KICK`) {
            ...
            let channel = client.channels.cache.get(ayarlar.kicklog)
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("guildMemberAdd", async member => {
        ...
        if (member.user.bot) {
            ...
            let channel = client.channels.cache.get(ayarlar.botlog)
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on('guildUpdate', async (oldGuild, newGuild) => {
        ...
        let channel = client.channels.cache.get(ayarlar.urllog)
    ...
    client.on("guildUpdate", async (oldGuild, newGuild) => {
        ...
        const moment = require('moment');
        moment.locale('tr');
        let channel = client.channels.cache.get(ayarlar.guildlog)
    ...
    client1.on("roleDelete", async role => {
        ...
        let channel = client1.channels.cache.get(ayarlar1.rollog)
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client1.on("roleUpdate", async (oldRole, newRole) => {
        ...
        if (matthe1.owners.includes(entry.executor.id)) return;
        if (matthe1.guvenlid.includes(entry.executor.id)) return;
        if (yetkiPermleri1.some(p => !oldRole.permissions.has(p) && newRole.permissions.has(p))) {
...
**Yetkilinin yetkileri alınıp karantinaya atıldı!**`)
    ...
    client1.on("guildMemberUpdate", async (oldMember, newMember) => {
        ...
        if (oldMember.nickname != newMember.nickname) {
            ...
            let channel = client1.channels.cache.get(ayarlar1.isimlog)
    ...
    client1.on("channelDelete", async channel => {
        ...
        let channel2 = client1.channels.cache.get(ayarlar1.kanallog)
  ...
  **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client2.on("webhookUpdate", async (channel) => {
        ...
        channel.guild.channels.cache.get(ayarlar2.weebhooklog).send(`${entry.executor} tarafından sunucuda izinsiz webhook açıldı, webhook silinip ve banlandı!`)
    ...
    client2.on("emojiDelete", async (emoji, message) => {
        ...
        let channel = client2.channels.cache.get(ayarlar2.emojilog)
  ...
  **Emoji eski haline getirildi ve yetkili jaile atıldı!**`)
  ...
  client1.on("ready", () => {
  client1.channels.cache.get(ayarlar.BotSesKanalı).join();
  });
...
client1.on("ready", () => {
  ...
  client2.on("ready", () => {
  client2.channels.cache.get(ayarlar.BotSesKanalı).join();
  });
